...
interface ILendingPool {
    ...
    function supply(address asset, uint256 amount, UILib.UniversalIdentity memory onBehalfOf) external;
    ...
    function withdraw(address asset, uint256 amount, UILib.UniversalIdentity memory to) external returns (uint256 withdrawnAmount);
    ...
    function repay(address asset, uint256 amount, UILib.UniversalIdentity memory onBehalfOf) external returns (uint256 repaidAmount);
    ...
    function borrow(address asset, uint256 amount, UILib.UniversalIdentity memory onBehalfOf) external;
}
