import { createWalletClient, custom, Hex, zeroAddress } from 'viem'
import { depositAndCall as evmDepositAndCall } from './evmGatewayWrite'
...
export const supply = async (
  ...
  if (connectedWallet.chainType === 'solana') {
    ...
    if (chainId === CHAINS.zetaAthens.id) {
      ...
      console.log('here')
      console.log(nativeAmountSupplied)
